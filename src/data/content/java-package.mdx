...
**Note:** Other programming languages may use a similar technique for
preventing duplicate identifiers from happening.  C++ uses the keyword
***namespace*** instead of ***package*** to do the same thing.
