...
![Program Memory](@data/content/images/Executable-Virtual-Memory.png "Figure 1: Program Memory")
...
using the ***new*** keyword.  It also stores the call stack whenever execution
...
In Java, any object created with the ***new*** keyword is a dynamic variable.
